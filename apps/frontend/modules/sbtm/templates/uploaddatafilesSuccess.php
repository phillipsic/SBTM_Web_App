...
<div id="sf_admin_container"> 
    <titles>Upload Data Files </titles>
<form enctype="multipart/form-data" action="<?php echo url_for('sbtm/uploaddata') ?>" method="POST">
...
<li class="sf_admin_action_delete">
            <?php echo link_to('Cancel', 'sbtm/datafiles', array('post' => true, 'confirm' => 'Are you sure?')) ?>
