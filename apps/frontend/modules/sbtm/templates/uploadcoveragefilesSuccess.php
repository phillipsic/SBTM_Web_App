...
<div id="sf_admin_container"> 
    <titles>Upload Coverage Files </titles>
<form enctype="multipart/form-data" action="<?php echo url_for('sbtm/uploadcoverage') ?>" method="POST">
...
<li class="sf_admin_action_delete">
            <?php echo link_to('Cancel', 'sbtm/managecoverage', array('post' => true, 'confirm' => 'Are you sure?')) ?>
