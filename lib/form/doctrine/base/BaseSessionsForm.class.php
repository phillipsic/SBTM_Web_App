...
abstract class BaseSessionsForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    'No'     => 'No',
      ...
      'tester'      => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Logins'),'method' => 'getValue', 'add_empty' => true)),
      ...
      'strategy_id' => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Strategy'), 'add_empty' => false)),
       'todochage_at'  => new sfWidgetFormInputHidden(),
    ...
    $this->setValidators(array(
      ...
      'todochage_at'  => new sfValidatorDateTime(),
