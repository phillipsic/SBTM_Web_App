...
abstract class BaseSessionsForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'tester'      => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('Logins'), 'add_empty' => false)),
  ...
  //    'updated_at'  => new sfWidgetFormDateTime(),
    ...
    $this->setValidators(array(
      ...
      'tester'      => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Status'))),
